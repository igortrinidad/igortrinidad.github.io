  ...
  <div class="align-center">
    ...
    <div class="terminal-window">
      <span class="terminal-header">
        <img class="ball-0 m-l-10" src="/icons/ball_red_0.svg">
        <img @click="menuIsOpen = false" class="ball-1 m-l-10" src="/icons/ball_red_1.svg">
        <img class="ball-0" src="/icons/ball_yellow_0.svg">
        <img @click="menuIsOpen = false" class="ball-1" src="/icons/ball_yellow_1.svg">
        <img class="ball-0" src="/icons/ball_green_0.svg">
        <img @click="menuIsOpen = true" class="ball-1" src="/icons/ball_green_1.svg">
      </span>
    ...
    <audio id="typing-audio" src="@/static/audio/typing.mp3" controls style="display: none;" />
    <audio id="typing-audio-short" src="@/static/audio/typing_short.mp3" controls style="display: none;" />
  </div>
</template>
